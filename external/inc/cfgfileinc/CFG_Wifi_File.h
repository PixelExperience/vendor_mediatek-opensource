...
}  WIFI_NVRAM_2G4_WF0_PATH_T, WIFI_NVRAM_2G4_WF1_PATH_T, *P_WIFI_NVRAM_2G4_WF0_PATH_T;
...
}  WIFI_NVRAM_5G_WF0_PATH_T, WIFI_NVRAM_5G_WF1_PATH_T, *P_WIFI_NVRAM_5G_WF0_PATH_T;
...
typedef struct _WIFI_SOC1_0_NVRAM_PARAM_STRUCT_T
{
    ...
    UINT_8 ucTypeID8;
    UINT_8 ucTypeLen8;
    WIFI_NVRAM_2G4_WF1_PATH_T r2G4WF1path;
    UINT_8 ucTypeID9;
    UINT_8 ucTypeLen9;
    WIFI_NVRAM_5G_WF1_PATH_T  r5GWF1path;
    UINT_8 ucTypeID10;
    UINT_8 ucTypeLen10;
    UINT_8 uc2G4WF1ShapingMode;
    WIFI_NVRAM_2G4_SHAPING_T  r2G4WF1shaping[14];
    /* NVRAM offset[1024] ~ offset[1279] */
    /* NVRAM offset[1280] ~ offset[1535] */
    /* NVRAM offset[1536] ~ offset[1791] */
    /* NVRAM offset[1792] ~ offset[2047] */
    UINT_8 aucReserved1[773]; // 1116 - 1 - 1 - 137 -1 - 1 - 157 -1 -1 -1 -42
