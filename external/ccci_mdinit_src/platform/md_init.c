...
#include "../../inc/cfgfileinc/CFG_MDTYPE_File.h"
#include "../../inc/CFG_file_lid.h"
#include "hardware/ccci_intf.h"
#include "../../inc/cfgfileinc/CFG_MD_SBP_File.h"
...
static bool check_nvram_ready(void)
{
    ...
    while (true)
    {
        ...
        {
            CCCI_LOGE("%s(), property_get(\"vendor.service.nvram_init\") = %s, read_nvram_ready_retry = %d",
