...
#define VENDOR_LIBRARY_VERSION "700.0.17031601"
#define BT_KO_INS_PROP "vendor.connsys.btdriver.init"
...
//#ifdef LOAD_DRIVER_BY_VENDOR
        property_get(BT_KO_INS_PROP, ko_prop, NULL);
        if (0 != strcmp(ko_prop, "true")) {
            if (property_set(BT_KO_INS_PROP, "true") < 0) {
                ((int*)param)[0] = -1;
                break;
            }
        }
